...
- Коды отказа: `pdf_missing`, `pdf_mismatch`, `blocks_json_missing`, `blocks_json_invalid`, `results_md_missing`, `schema_version_unsupported`, `coordinate_space_unsupported`, `archive_unsafe`, `archive_corrupt`, `too_large`, `pdf_unreadable`, `export_group_mismatch`.
