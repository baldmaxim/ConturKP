...
Состояние на этап 01 (2026-09-17). Кода интеграций нет. Факты и ссылки — в `docs/discovery.md`; контракты адаптеров — в `docs/contracts/adapters.md`; владельцы доработок — в `docs/architecture/unknowns.md`.
...
| RDWeb (импорт экспорта) | образец `schema_version` 1, хэш совпал с архивом владельца (ревью 00-1); другие варианты схемы неизвестны (Q-02) | не требуется: файловый импорт | NOT_IMPLEMENTED | — | — | не назначен | 04 |
