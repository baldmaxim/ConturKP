...
Последнее ревью этапа 04: `docs/reviews/04-review-2.md` — CHANGES_REQUIRED (R04-01…R04-06 закрыты ревью, найдены R04-07…R04-13); R04-07…R04-13 исправлены, ожидают повторного ревью
...
| 04 RDWeb | READY_FOR_REVIEW | передача 1: `89024f8` → … → `de90029`; ревью 04-1: `ec6d86d` → … → `ebcdb6d`; ревью 04-2: `9f10327` → `080ec16` → `b98ddd7` → `f94d81c` → `cc56f5f` (база `301e7f2`) | `docs/stages/04-report.md` | `04-review-1.md` — CHANGES_REQUIRED (R04-01…R04-06 закрыты); `04-review-2.md` — CHANGES_REQUIRED (R04-07…R04-13 исправлены) | Q-02 (другие варианты схемы экспорта); X-05 — только автоматическая постановка задач, вне объёма этапа (D-010) |
