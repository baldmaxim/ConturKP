...
Последнее ревью этапа 04: `docs/reviews/04-review-3.md` — CHANGES_REQUIRED (R04-07, R04-09…R04-11, R04-13 закрыты ревью; R04-08 и R04-12 закрыты частично, найдены R04-14…R04-17); R04-08, R04-12, R04-14…R04-17 исправлены, ожидают повторного ревью
...
| 04 RDWeb | READY_FOR_REVIEW | передача 1: `89024f8` → … → `de90029`; ревью 04-1: `ec6d86d` → … → `ebcdb6d`; ревью 04-2: `9f10327` → … → `cc56f5f`; ревью 04-3: `4951d3a` → `c2dbae0` → `27d11b0` → `7b48001` → `8409b34` (база `301e7f2`) | `docs/stages/04-report.md` | `04-review-1.md`, `04-review-2.md` — CHANGES_REQUIRED (закрыты); `04-review-3.md` — CHANGES_REQUIRED (R04-08, R04-12, R04-14…R04-17 исправлены) | Q-02 (другие варианты схемы экспорта); X-05 — только автоматическая постановка задач, вне объёма этапа (D-010) |
