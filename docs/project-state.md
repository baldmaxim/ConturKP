...
Текущий этап: 01 Архитектура — READY_FOR_REVIEW
...
Ближайшее действие: независимое ревью этапа 01 по `docs/spec/04_CODEX_REVIEW.md` (шаблон A и архитектурная контрольная точка D); ответы владельца на Q-01, Q-03, Q-13; слияние `stage-00` и `stage-01` в `main` — по решению владельца
...
| 01 Архитектура | READY_FOR_REVIEW | `stage-01` (база `cbe5bf5`) | `docs/stages/01-report.md` | — | нет блокирующих ревью; Q-01, Q-03, Q-05, Q-13 остаются открытыми |
