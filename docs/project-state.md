...
Текущий этап: 04 RDWeb — NOT_STARTED; этап 03 принят
HEAD / рабочее дерево: ветка `stage-03` — принятый коммит `6f685424102d06021e766c5edebdc4cbd849d942` и документационное закрытие ревью 03-5; после коммита дерево чистое
...
Ближайшее действие: этап 04 — RDWeb как основное распознавание; слияние `stage-00`…`stage-03` в `main` — по решению владельца
