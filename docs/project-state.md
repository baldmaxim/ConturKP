...
Текущий этап: 02 Каркас и права — READY_FOR_REVIEW
HEAD / рабочее дерево: ветка `stage-02` (от `77f9004`) — коммит этапа 02; после коммита дерево чистое
Последнее принятое ревью: `docs/reviews/01-review-4.md` — PASS, этап 01 принят по коммиту `f8a0f20`
Ближайшее действие: независимое ревью этапа 02 по `docs/spec/04_CODEX_REVIEW.md`; слияние `stage-00`, `stage-01` в `main` — по решению владельца
...
| 02 Каркас и права | READY_FOR_REVIEW | `stage-02` (база `77f9004`) | `docs/stages/02-report.md` | ожидает ревью | нет; U-02 — для доступа из LAN |
