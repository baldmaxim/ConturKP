...
Текущий этап: 02 Каркас и права — NOT_STARTED; этап 01 принят
HEAD / рабочее дерево: ветка `stage-01` — принятый коммит `f8a0f20` и запись о приёмке; после коммита дерево чистое
Последнее принятое ревью: `docs/reviews/01-review-4.md` — PASS, этап 01 принят по коммиту `f8a0f20`
Ближайшее действие: этап 02 — каркас, БД и права; слияние `stage-00`, `stage-01` в `main` — по решению владельца
