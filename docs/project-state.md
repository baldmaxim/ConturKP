...
Текущий этап: 03 Источники и очередь — CHANGES_REQUIRED (ревью 03-2), исправления R03-03, R03-04, R03-05 готовы к повторному ревью
HEAD / рабочее дерево: ветка stage-03 (от 7457833) — коммит исправлений по ревью 03-2; после коммита дерево чистое
Последнее принятое ревью: `docs/reviews/02-review-2.md` — PASS, этап 02 принят по коммиту `a32556d`
Ближайшее действие: повторное независимое ревью этапа 03 (R03-03, R03-04, R03-05); слияние stage-00…stage-03 в main — по решению владельца
...
| 03 Источники и очередь | CHANGES_REQUIRED | `stage-03` (база `7457833`; ревью 03-1 — `2234d18`, ревью 03-2 — `97342f3`) | `docs/stages/03-report.md` | `docs/reviews/03-review-1.md` — CHANGES_REQUIRED; `docs/reviews/03-review-2.md` — CHANGES_REQUIRED (закрыты R03-01, R03-02, R03-06…R03-09); исправления R03-03, R03-04, R03-05 ждут повторного ревью | нет; U-05, U-08 — проверки на целевом ПК |
