...
Текущий этап: 04 RDWeb — ACCEPTED (ревью 04-5 — PASS); этап 05 разрешён к началу. Объём этапа 04 сужен владельцем до импорта результатов распознавания (D-010)
HEAD / рабочее дерево: ветка `stage-04`; этап принят по коммиту `f46ad88c7623e641b8dd8e1c9df637a7947f7012` (HEAD передачи `e380c02b27199ec0767dc3c6e1d41f0930fec319`), затем документальный коммит закрытия по ревью 04-5
Последнее принятое ревью: `docs/reviews/04-review-5.md` — PASS, этап 04 принят по коммиту `f46ad88c7623e641b8dd8e1c9df637a7947f7012`
Последнее ревью этапа 04: `docs/reviews/04-review-5.md` — PASS; R04-01…R04-18 закрыты ревью. Неблокирующее наблюдение ревью 04-5 §8 (фрагмент без страницы) записано как R04-19 и отнесено к этапу 05
Ближайшее действие: этап 05 — разрешён ревью 04-5 после этого документального коммита закрытия (повторное ревью коммита не требуется); слияние `stage-00`…`stage-04` в `main` — по решению владельца
...
| 04 RDWeb | ACCEPTED | передача 1: `89024f8` → … → `de90029`; ревью 04-1: `ec6d86d` → … → `ebcdb6d`; ревью 04-2: `9f10327` → … → `cc56f5f`; ревью 04-3: `4951d3a` → `c2dbae0` → `27d11b0` → `7b48001` → `8409b34` (база `301e7f2`); ревью 04-4: `9ded089` → `f46ad88`; принят по `f46ad88c7623e641b8dd8e1c9df637a7947f7012` | `docs/stages/04-report.md` | `04-review-1.md`, `04-review-2.md` — CHANGES_REQUIRED (закрыты); `04-review-3.md` — CHANGES_REQUIRED (R04-08, R04-12, R04-14…R04-17 исправлены); `04-review-4.md` — CHANGES_REQUIRED (R04-08, R04-12, R04-16, R04-17 закрыты, найден R04-18); `04-review-5.md` — PASS, этап принят | нет; Q-02 (другие варианты схемы экспорта) и X-05 (автоматическая постановка задач — вне объёма, D-010) остаются открытыми и этап 05 не блокируют; R04-19 — наблюдение ревью 04-5, закрывается на этапе 05 |
